...
// 	// public string ipServer = "188.76.177.198";
// 	// void Start () {
		
// 	// 	//Esto sale de aqui -> https://docs.unity3d.com/Manual/UNetUsingTransport.html
...
// 	// 	//Topologia (Cuantas conexiones simultaneas)
// 	// 	HostTopology topology = new HostTopology(config, 4);
// 	// 	//Crear Host (Abrir Socket)
// 	// 	int hostId = NetworkTransport.AddHost(topology, 8888);
// 	// 	//Comunicacion
// 	// 	int bufferLength = 400;
// 	// 	byte[] buffer = new byte[bufferLength];
// 	// 	byte error;

// 	// 	int connectionId = NetworkTransport.Connect(hostId, ipServer, 8888, 0, out error);
